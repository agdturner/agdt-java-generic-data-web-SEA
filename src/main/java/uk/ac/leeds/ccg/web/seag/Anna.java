 ...
 */
package uk.ac.leeds.ccg.web.seag;
...
public class Anna extends Web_Scraper {
    ...
    public static void main(String[] args) {
        try {
            new Anna(new Web_Environment(new Data_Environment(
                    new Generic_Environment(new Generic_Defaults())))).run(args);
        } catch (Exception ex) {
    ...
    public void run() throws IOException {
        ...
        dir = Paths.get(System.getProperty("user.dir"), "data", "seag", "anna");
